...
$\bullet$ \textbf{Productos Tensoriales de Irreps} (ejemplos): $\textbf{8} \otimes {\textbf{8}} = \textbf{1} \oplus {\textbf{8}} \oplus \textbf{8} \oplus \textbf{10}\oplus \overline{\textbf{10}} \oplus {\textbf{27}}$\\
